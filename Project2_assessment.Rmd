...
```
and here is the harm missing plot
```{r}
par(las=2)
barplot(plotHarmData$Total.Harm, names.arg=as.character(plotHarmData$EventType), horiz=T, xlim=c(0,30000))
...
Here is the missing bar plot
```{r}
par(las=2)
barplot(plotCostData$Total.Damage, names.arg=as.character(plotCostData$EventType), horiz=T, xlim=c(0,200000.0))
